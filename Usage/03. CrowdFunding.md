...
4. 배포된 계약을 통해 다음과 같은 기능들을 테스트한다:
    ...
    ![crowdfunding](../image/cflaunch.png)<br>
    - ERC20 Token Smart Contract에서 `approve` function을 호출하여 `CrowdFund` Smart Contract가 Token을 전송할 수 있도록 승인 <br>
    ![crowdfunding](../image/cfapprove.png)<br>
    - 캠페인에 기부 (`pledge`) <br>
    ![crowdfunding](../image/cfpledge.png)<br>
    - 기부 취소 (`unpledge`) <br>
    ![crowdfunding](../image/cfunpledge.png)<br>   
    - 목표 금액 달성 시 자금 인출 (`claim`) <br>
    ![crowdfunding](../image/cfclaim.png) <br>   
    - 목표 금액 미달성 시 기부금 환불 (`refund`) <br>
    ![crowdfunding](../image/cfrefund.png)<br>  
